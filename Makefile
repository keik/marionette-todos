...
run-dev-server: node_modules
	@NODE_ENV="dev" node_modules/.bin/budo src/scripts/main.js:src/bundle.js
...
$(DIST)/bundle.js: node_modules $(DIST)
	@NODE_ENV="prod" node_modules/.bin/browserify src/scripts/main.js | node_modules/.bin/uglifyjs --comments /license\|copyright/img -o $@
